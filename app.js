...
const foodData = {
    saharlik: [
        ...
        { name: 'Charvi Dolma', img: 'images/chavri-dolma.png' },
        { name: 'Samarqand Nohat-shorak', img: 'images/samarqand-nohot-shorak.png' },
        { name: 'Jizz', img: 'images/jizz.png' },
        { name: 'Narhangi', img: 'images/narhangi.png' },
        ...
        { name: 'Langet', img: 'images/langet.png' },
        { name: 'Moshhorda', img: 'images/moshhorda.png' },
        { name: 'Dapanji', img: 'images/dapanji.png' },
    ],
    iftorlik: [
